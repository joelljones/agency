					...
					<div className="fixed inset-0 overflow-y-auto">
						<div className="flex min-h-full items-center justify-center">
							...
							>
								<Dialog.Panel
									id=":r6i:"
									class="transform-origin-center relative z-50 flex h-screen w-screen transform-none flex-col overflow-hidden bg-neutral-950 pt-2 transition-all"
								>
									<div class="transform-origin-center transform-none bg-neutral-800">
												...
												<div class="mx-auto max-w-2xl lg:max-w-none">
													<div class="grid grid-cols-1 gap-y-10 pb-16 pt-10 sm:grid-cols-2 sm:pt-16">
															...
															<ul role="list" class="mt-6 grid grid-cols-1 gap-8 sm:grid-cols-2">
																<li>
																	<address class="text-sm not-italic text-neutral-300">
																		<strong class="text-white">Copenhagen</strong>
																		<br />1 Carlsberg Gate
																		<br />
																...
																<li>
																	<address class="text-sm not-italic text-neutral-300">
																		<strong class="text-white">Billund</strong>
																		<br />
																		24 Lego Allé
																		<br />
														...
														<div class="sm:border-l sm:border-transparent sm:pl-16">
															...
															<ul role="list" class="mt-6 flex gap-x-10 text-white">
																<li>
																	<a
																		aria-label="Facebook"
